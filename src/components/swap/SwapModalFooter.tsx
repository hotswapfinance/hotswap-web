import { Trade, TradeType } from '@hotswapbsc/hotswap-sdk'
      ...
      <AutoColumn gap="0px">
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper text="For each trade a 0.2% fee is paid. 0.17% goes to liquidity providers and 0.03% goes to the HotSwap treasury." />
          </RowFixed>
          <TYPE.black fontSize={14}>
